...
if __name__ == "__main__":
    ...
    img_queue = mp.JoinableQueue(maxsize=1024)
    ...
    for i in range(num_producer):
        ...
        p = mp.Process(target=producer, name="Producer-%d"%i, args=(img_queue, sub_urls, batch_size,))
        producer_list.append(p)

    c = mp.Process(target=consumer, name="Consumer", args=(config, img_queue, batch_size, log_file,))
